<p class="input_heading"> Enter Birth Date</p>
<ol class="age-gate-form-elements">
  ...
  <li class="age-gate-form-section">
    ...
    <input type="text" name="age_gate[y]" class="age-gate-input" id="age-gate-y" value="<?php echo (isset($age['y']) ? $age['y'] : '') ?>" placeholder="<?php _e('Year', 'age-gate'); ?>" required minlength="4" maxlength="4" pattern="[0-9]*" inputmode="numeric" autocomplete="off">
  </li>
</ol>
