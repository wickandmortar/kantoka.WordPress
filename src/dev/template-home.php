...
<section class="left_right_content">
	<div class="container-fluid">
		...
		<div class="row">
			...
			<style>
				.img_col_1{
					background-image:url('<?php echo get_template_directory_uri();?>/assets/images/section_1_1.jpg');
				...
				only screen and (                min-resolution: 2dppx) { 
					.img_col_1{
						background-image:url('<?php echo get_template_directory_uri();?>/assets/images/kantoka-photo-10.jpg');
					}
		...
		<div class="row">
			...
			<style>
				.img_col_2{
					background-image:url('<?php echo get_template_directory_uri();?>/assets/images/section_1_2.jpg');
...
<section class="home_mission">
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-6 img-col order-1 order-md-2 mission_bg"></div>


			<style>
				.mission_bg{
					background-image:url('<?php echo get_template_directory_uri();?>/assets/images/mission.jpg');
				...
				only screen and (                min-resolution: 2dppx) { 
					.mission_bg{
						background-image:url('<?php echo get_template_directory_uri();?>/assets/images/kantoka-photo-13.jpg');
					}
...
<section class="feature-table">
    <div class="feature-table-container">
        ...
        <div class="feature-table-item item-1">

        	
        	<style>
        		.item-1{
        			background: url('<?php echo get_template_directory_uri(); ?>/assets/images/icon_1_img.jpg');
        		}
        	...
        	<div class="bg_color_container"></div>
            <div class="feature-table-content text-center">
				<!-- 
				<img class="black" src="<?php echo get_template_directory_uri(); ?>/assets/images/marketplace-black.svg" alt="">
				<img class="white" src="<?php echo get_template_directory_uri(); ?>/assets/images/marketplace-pink.svg" alt=""> -->
        ...
        <div class="feature-table-item item-2">
        	
        	<style>
        		.item-2{
        			background: url('<?php echo get_template_directory_uri(); ?>/assets/images/icon_2_img.jpg');
				...
				only screen and (                min-resolution: 2dppx) { 
					...
					.item-2{
	        			background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/brooke-cagle-YpefHkUc8BQ-unsplash.jpg');
				...
				only screen and (                min-resolution: 2dppx)  and (max-width: 1000px){ 
					...
					.item-2{
	        			background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/brooke-cagle-YpefHkUc8BQ-unsplash-1000.jpg');
	        			background-position:35% 0;
	        		}
				} 				        		
            ...
            <div class="feature-table-content text-center">
				...
				<!-- <img class="black" src="<?php echo get_template_directory_uri(); ?>/assets/images/tele-medicine-black.svg" alt="">
				<img class="white" src="<?php echo get_template_directory_uri(); ?>/assets/images/tele-medicine-pink.svg" alt=""> -->
        ...
        <div class="feature-table-item item-3">

        	<style>
        		.item-3{
        			background: url('<?php echo get_template_directory_uri(); ?>/assets/images/icon_3_img.jpg');
        		}
            ...
            <div class="feature-table-content text-center">
				...
				<svg class="black" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="117" height="113" viewBox="0 0 117 113">
  				<image id="job-portal-black.svg" width="117" height="113" xlink:href="data:img/png;base64,"/>
				</svg>



				<svg class="white" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="117" height="113" viewBox="0 0 117 113">
  				<image id="job-portal-pink.svg" width="117" height="113" xlink:href="data:img/png;base64,"/>
				</svg>
